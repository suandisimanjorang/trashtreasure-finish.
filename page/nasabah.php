...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Nasabah</title>
		<link rel="stylesheet" href="../asset/internal/css/styles2.css">
	...
	<body>
		<div class="sidebar">
			<ul>
				<li>
					<a href="nasabah.php?page=data-nasabah" style="text-align: center; padding: 30px 0 30px 0; font-size: 20px;"><span class="fa fa-home" aria-hidden="true"></span>Beranda</a>
				</li>
