    ...
    if(isset($_POST['simpan'])){
      ...
      if (mysqli_fetch_array($sql) > 0) {
        echo "<script>
              ...
              content='0; url=http://localhost/TrashTreasure/page/admin.php?page=data-nasabah-full'>";
...
<body>
	   <h2 style="font-size: 30px; color: darkcyan;">Tambah Data Nasabah</h2>
	   ...
	   <form id="daftar_user" action="" method="post" onsubmit="return cek_data()">
         ...
         <div class="form-group">
           ...
           <input type="password" placeholder="Masukan password" name="password" id="inputPassword"/>
           <br><br>
