<?php
 if (isset($_POST['simpan'])) {
  ...
  echo "<meta http-equiv='refresh'
   content='0; url=http://localhost/TrashTreasure/page/admin.php?page=data-setor'>";
...
<body>
		<h2 style="font-size: 30px; color: darkcyan;">Setor Sampah</h2>
		<button type="button" id="btn-tambah-form"><b>Tambah</button>
		<button type="button" id="btn-reset-form">Reset</b></button><br><br>
     <form id="daftar_user" name='autoSumForm' action="" method="post" onsubmit="return cek_data()">
         ...
         <div class="form-group">
          ...
          <input type="text" placeholder="Otomatis terisi" style="cursor: not-allowed;" id="harga" name="harga"  onkeyup="sum();" readonly />
